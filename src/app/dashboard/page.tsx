                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-muted/30 p-4 shadow-sm">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="shrink-0 text-2xl font-semibold tracking-tight">{analytics.completionRate}%</span>
                    </div>
                  ...
                  {analytics.insightItems.map((insight) => (
                    <div key={insight.title} className="flex items-start gap-2 rounded-[1.15rem] border border-white/10 bg-muted/20 p-2.5 sm:gap-3 sm:rounded-2xl sm:p-4 shadow-sm transition-transform duration-300 hover:-translate-y-0.5 hover:border-primary/20">
                      ...
                      <div className="min-w-0 space-y-1">
                        ...
                        <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-white/10 bg-background/60 px-2 py-0.5 text-[9px] font-medium uppercase tracking-[0.12em] text-muted-foreground sm:px-2.5 sm:py-1 sm:text-[11px] sm:tracking-[0.16em]">
                          Insight Snapshot
                        </div>
                      </div>
                    </div>
                ...
                <CardContent className="space-y-3">
                  {analytics.tagData.length > 0 ? analytics.tagData.map((tag) => (
                    <button
                      ...
                      className="group block w-full min-w-0 space-y-2 rounded-2xl px-1 py-1 text-left transition-colors duration-300 hover:bg-muted/20"
                    >
                      <div className="flex items-center justify-between gap-3">
