...
export default function DashboardPage() {
  ...
  return (
    <div id="dashboard-page" className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-base text-muted-foreground mb-8 font-normal">
        An overview of your team's progress and activity.
      </p>
      {tasks.length === 0 ? (
         <div className="text-center py-16 text-muted-foreground border-2 border-dashed rounded-lg">
          <p className="text-lg font-normal">No data to display.</p>
                ...
                {summaryStats.map((stat, index) => (
                    <Card key={index} className={cn("border-t-4 transition-all hover:shadow-xl hover:-translate-y-1", stat.borderColor)}>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-[10px] font-semibold tracking-widest uppercase text-muted-foreground">{stat.title}</CardTitle>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription className="font-normal text-sm">Distribution of tasks across all statuses.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <ChartContainer config={tasksByStatusConfig} className="h-[300px] w-full">
                            <RechartsBarChart data={tasksByStatusData} accessibilityLayer>
                                 ...
                                 />
                                 <YAxis tickLine={false} axisLine={false} tickMargin={8} allowDecimals={false} className="font-normal text-[10px]" />
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold tracking-tight">
                         ...
                         <CardDescription className="font-normal text-sm">Tasks created vs. completed over the last 6 months.</CardDescription>
                    </CardHeader>
                    <CardContent className="h-[300px]">
                       <ChartContainer config={monthlyChartConfig} className="h-full w-full">
                            <RechartsLineChart data={monthlyData} accessibilityLayer>
                                <XAxis dataKey="name" tickLine={false} axisLine={false} tickMargin={8} className="font-normal text-[10px]" />
                                <YAxis tickLine={false} axisLine={false} tickMargin={8} allowDecimals={false} className="font-normal text-[10px]" />
                                <ChartTooltip content={<ChartTooltipContent />} />
                                <Legend wrapperStyle={{ paddingTop: '20px', fontWeight: 500, fontSize: '11px' }} />
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold tracking-tight">
                         ...
                         <CardDescription className="font-normal text-sm">Breakdown of task assignments to Developers.</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription className="font-normal text-sm">Count of completed deployments per environment.</CardDescription>
                    </CardHeader>
                    <CardContent>
                 ...
                 <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold tracking-tight">
                         ...
                         <CardDescription className="font-normal text-sm">Distribution of tasks across different tags.</CardDescription>
                    </CardHeader>
                    <CardContent>
                 ...
                 <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold tracking-tight">
                         ...
                         <CardDescription className="font-normal text-sm">Distribution of tasks across different repositories.</CardDescription>
                    </CardHeader>
                    <CardContent>
