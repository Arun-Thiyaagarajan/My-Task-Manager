...
export const INITIAL_UI_CONFIG: FieldConfig[] = [
  ...
  { id: 'field_developers', key: 'developers', label: 'Developers', type: 'multiselect', group: 'Assignment & Tracking', isActive: true, isRequired: false, isCustom: false, order: 4, options: [] },
  ...
  { id: 'field_deploymentDates', key: 'deploymentDates', label: 'Deployment Dates', type: 'date', group: 'Dates', isActive: false, isRequired: false, isCustom: false, order: 9 },
