...
export function CommentsSection({ taskId, comments, onCommentsUpdate, readOnly = false }: CommentsSectionProps) {
  ...
  return (
    <Card>
      <Accordion type="single" collapsible className="w-full" defaultValue="comments">
        <AccordionItem value="comments" className="border-none">
          <CardHeader className="p-0">
            <AccordionTrigger className="flex items-center gap-2 text-xl px-6 py-4 hover:no-underline [&>svg]:ml-auto">
