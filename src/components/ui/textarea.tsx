    ...
    return (
        <Popover open={isMentionOpen} onOpenChange={setIsMentionOpen}>
            <PopoverAnchor asChild>
                <textarea
                    className={cn(
                    "flex min-h-[120px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm transition-[height,color,border-color,background-color] duration-200 placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary disabled:cursor-not-allowed disabled:opacity-50 overflow-y-auto resize-none",
                    className
                    )}
                    ref={combinedRef}
